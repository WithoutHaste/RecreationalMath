...
namespace WithoutHaste.Sequences
{
	...
	public class CircularPrime : Sequence
	{
		...
		{
			int[] primes = new Prime(Max * 10).Numbers; //going order of magnitude higher than prime because rotating prime could end up with a higher number; ex: 17 => 71
		...
		private bool IsCircularPrime(int p, int[] primes)
		{
			if(p < 10)
				return true;
			string s = p.ToString();
